...
Females height seems to follow a normal distribution

```{r}
hist(mdims$hgt)
```
    
Males height seems to follow a normal distribution
...
**Yes, it still follow the normal distribution.**
...
**The points seems to be identical with the theoritical data even on the plot tail**
...
4.  Does the normal probability plot for `fdims$hgt` look similar to the plots 
    ...
    **Yes, the probability plot for female height is similar to simulated data ploats and the plots do show that female heights are nearly normal.**
...
**Female weight seems to approximately follow normal distribution but with a slight right skew.**
...
**What percentage of Values fall within one standard deviation of mean Female Height**

As per theoretical normal distribution heights within one standard deviation of mean should be about 68.2%
Actual heights within one standard deviation of mean = 69.2307692%

**Female Weight**

As per theoretical normal distribution weights within one standard deviation of mean should be about 68.2%
...
Actual weights within one standard deviation of mean = 70.7692308%

In this case female height seems to be more closer to theoretical probability.

**Median**
Median of the normal distribution is same as mean
As per theoretical model Median of heights = 164.8723077
Actual median of heights 164.5

As per theoretical model median of weights = 60.6003846
Actual median of weights = 59

Female height seems to be more closer to theoretical value in this case as well. Based on the two questions we could see that female height is closer to theoretical distribution.
...
-   Note that normal probability plots C and D have a slight stepwise pattern.  
    ...
    **I think the stepwise pattern is because the repetitive values isn't continous**
...
**Based on the probability plot, it seems that this variable is right-skewed**

```{r}
fkmean <- mean(fdims$kne.di)
fksd <- sd(fdims$kne.di)
