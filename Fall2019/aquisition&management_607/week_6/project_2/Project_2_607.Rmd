...
### Dataset_1: International migrant stock By destination and origin {.tabset .tabset-fade .tabset-pills}
...
First, we need to condense the age groups into categorial factor to be easy to visualize. To do that, we can construct a for-loop to iterate over the merged_age dataframe and change the value into the category we want child, youth, adult, and senior migrants as the table below:
