...
As results show, the **Author** columns has a nested array children _books with multiple authors_. To solve this issue, we can use **tidyverse** to mutate that column to separate in the **,**
