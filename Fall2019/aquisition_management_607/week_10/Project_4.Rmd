...
```{r Loading Libraries, warning=FALSE, load libraries message=FALSE}
library(R.utils)
library(tidyverse)
library(tidytext)
library(readtext)
...
> Note: we took a sample of 10% of each generated dataset, my computer Ram processor was running very slow. 
