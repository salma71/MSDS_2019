...
Our model employs a total of 8092 support vectors while building this classification model.
...
The Support Vector Machine model performed badly on this dataset as the model performed exactly as a mere guess. With the accuracy of 69.85%, we may be tempted to think the performance is good but a closer look at specificity rate of 0% suggest our model is not doing good.
