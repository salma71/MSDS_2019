...
I used different IDE to write the XML file - because R studio doesn't support the xml markup language. For this assignment, I used [Visual studio code IDE](https://visualstudio.microsoft.com/) from Microsoft. Then, I pushed the .xml, .json, and .html file to my [GitHub account](https://github.com/salma71/MSDS_2019/tree/master/Fall2019/aquisition%26management_607/week_7) and used the **getURL()** to pull down the data into R

```{r xml}

url <- 
  getURL("https://raw.githubusercontent.com/salma71/MSDS_2019/master/Fall2019/aquisition%26management_607/week_7/book_info.xml")
...
url_json <- 
  getURL("https://raw.githubusercontent.com/salma71/MSDS_2019/master/Fall2019/aquisition%26management_607/week_7/book_info.json")
...
json_df <- json_df %>% 
  ...
  separate(Author, c("Author", "Co_Author"), sep = ",")
json_df
```
...
```{r}
url_html <- 
  getURL("https://raw.githubusercontent.com/salma71/MSDS_2019/master/Fall2019/aquisition%26management_607/week_7/book_info.html")
...
+ [GitHub repo](https://github.com/salma71/MSDS_2019/tree/master/Fall2019/aquisition%26management_607/week_7)
